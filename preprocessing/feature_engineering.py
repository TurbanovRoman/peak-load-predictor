...
class FeatureBuilder:
    ...
    def __init__(self, exog_cols=None):
        ...
        # известны заранее и включаются в FEATURE_COLS, если присутствуют в данных.
        self.exog_cols = exog_cols or []

    @property
    def FEATURE_COLS(self):
        # dict.fromkeys убирает дубли, если exog_cols пересекаются с _EXTRA_NAMES
        # (например, is_holiday уже входит в _EXTRA_NAMES).
